						...
						<form action="" method="post" autocomplete="off">
							...
							<div class="mb-3">
								<div class="row no-gutters">
									...
									<div class="col-12 col-md-6">
										<div class="col-12">
											<label for="imgproducfile" class="form-label">Imagen Producto:</label>
											...
											<div class="row">
												<div class="col-6" id="divimgpreview">
													<img src="images/UploadLogo.jpg" class="img-fluid" name="imgPreview" id="imgPreview" style="width: 100%; max-height: 180px; border: 1px solid black;" >
												</div>
